...
# model with both jc_similarity and relatedness
...
# model with interaction term b/w jc_similarity & specific relation
...
# model with cosine and relatedness
...
# which one is better? cosine or wordnet?
